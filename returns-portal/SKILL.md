---
name: web-coding-skills-returns-portal
description: Used when building returns portal software on the web. Returns portal for RMA creation, eligibility rules, reverse-logistics state, and refund closure.
---
