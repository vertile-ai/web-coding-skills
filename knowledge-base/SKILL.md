---
name: web-coding-skills-knowledge-base
description: Used when building knowledge base software on the web. Knowledge base platform for authored docs, revisions, publication workflow, and discoverable search.
---
