---
name: web-coding-skills-event-ticketing
description: Used when building event ticketing software on the web. Event ticketing software for inventory allocation, checkout windows, issuance, and gate validation.
---
