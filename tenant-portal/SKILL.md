---
name: web-coding-skills-tenant-portal
description: Used when building tenant portal software on the web. Tenant self-service portal for requests, documents, payments, and operational status tracking.
---
