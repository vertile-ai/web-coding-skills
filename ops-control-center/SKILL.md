---
name: web-coding-skills-ops-control-center
description: Used when building ops control center software on the web. Operational command center for multi-tenant B2B systems: incidents, alerts, SLA breaches, and escalation state.
---
