---
name: web-coding-skills-crm-workspace
description: Used when building crm workspace software on the web. CRM workspace for contact/account timelines, activity capture, and pipeline handoff workflows.
---
