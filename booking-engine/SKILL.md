---
name: web-coding-skills-booking-engine
description: Used when building booking engine software on the web. Booking engine for reservable resources with slot generation, conflict prevention, and hold/confirm flows.
---
