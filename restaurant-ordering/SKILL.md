---
name: web-coding-skills-restaurant-ordering
description: Used when building restaurant ordering software on the web. Restaurant ordering platform for menu/cart/checkout, order lifecycle, and fulfillment channel routing.
---
