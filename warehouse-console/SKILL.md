---
name: web-coding-skills-warehouse-console
description: Used when building warehouse console software on the web. Warehouse console for receiving, put-away, pick-pack-ship, and exception processing.
---
