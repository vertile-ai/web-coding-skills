---
name: web-coding-skills-applicant-tracking
description: Used when building applicant tracking software on the web. Applicant tracking system with stage transitions, interviewer coordination, and hiring decision logs.
---
