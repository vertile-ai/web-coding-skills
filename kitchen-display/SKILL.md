---
name: web-coding-skills-kitchen-display
description: Used when building kitchen display software on the web. Kitchen display system for ticket sequencing, prep station routing, and expo/ready state transitions.
---
