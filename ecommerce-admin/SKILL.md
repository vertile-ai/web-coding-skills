---
name: web-coding-skills-ecommerce-admin
description: Used when building ecommerce admin software on the web. E-commerce admin console for catalog, order, fulfillment, discount, and refund operations.
---
