---
name: web-coding-skills-customer-support
description: Used when building customer support software on the web. Customer support desk for ticket intake, assignment, SLA control, and resolution playbooks.
---
