---
name: web-coding-skills-document-signing
description: Used when building document signing software on the web. Document signing workflow with template generation, signer state tracking, and tamper-evident audit logs.
---
