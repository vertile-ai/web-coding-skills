---
name: web-coding-skills-incident-console
description: Used when building incident console software on the web. Incident response workspace focused on alert triage, severity routing, on-call ownership, and timeline evidence.
---
