---
name: web-coding-skills-dispatch-board
description: Used when building dispatch board software on the web. Real-time dispatch board for allocating jobs to agents/vehicles with live state and exception handling.
---
