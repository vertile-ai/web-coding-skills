---
name: web-coding-skills-patient-intake
description: Used when building patient intake software on the web. Patient intake workflow for demographics, consent, insurance details, and pre-visit data quality checks.
---
