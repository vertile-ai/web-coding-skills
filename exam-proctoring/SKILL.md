---
name: web-coding-skills-exam-proctoring
description: Used when building exam proctoring software on the web. Exam proctoring system for exam session control, identity checkpoints, violation events, and audit review.
---
